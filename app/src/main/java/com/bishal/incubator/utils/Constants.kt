...
// fragment numbers
const val HOME_FRAGMENT_NUMBER = 0
const val SEARCH_FRAGMENT_NUMBER = 1
const val ADD_POST_FRAGMENT_NUMBER = 2
const val INCUBATES_FRAGMENT_NUMBER = 3
const val PROFILE_FRAGMENT_NUMBER = 4